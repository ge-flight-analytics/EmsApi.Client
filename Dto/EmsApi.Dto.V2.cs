...
namespace EmsApi.Dto.V2
{
    ...
    /// <summary>Represents an API client application that consumes REST services hosted in the website.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class ApiClient 
    {
        /// <summary>The unique integer identifier of the API client</summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.Always)]
        public int Id { get; set; }
    
        /// <summary>The unique, user friendly, client ID of the client, used when clients request tokens to access the API</summary>
        [Newtonsoft.Json.JsonProperty("clientId", Required = Newtonsoft.Json.Required.Always)]
        public string ClientId { get; set; }
    
        /// <summary>A brief summary describing the API client and its purpose</summary>
        [Newtonsoft.Json.JsonProperty("description", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Description { get; set; }
    
        /// <summary>The grant type that may be used by the client to access the API</summary>
        [Newtonsoft.Json.JsonProperty("grantType", Required = Newtonsoft.Json.Required.Always)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public ApiClientGrantType GrantType { get; set; }
    
        /// <summary>Indicates whether the API client is active and can currently consume the API</summary>
        [Newtonsoft.Json.JsonProperty("enabled", Required = Newtonsoft.Json.Required.Always)]
        public bool Enabled { get; set; }
    
        /// <summary>The date and time at which the API client record was created</summary>
        [Newtonsoft.Json.JsonProperty("created", Required = Newtonsoft.Json.Required.Always)]
        public System.DateTime Created { get; set; }
    
        /// <summary>The date and time at which the API client record was last updated</summary>
        ...
        public static ApiClient FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ApiClient>(data);
        }
    ...
    /// <summary>Represents a new API client application that consumes REST services hosted in the website that can be provided
    ///             when creating a new client record.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class ApiClientNew 
    {
        /// <summary>The unique, user friendly, client ID of the client used when clients request tokens to access the API</summary>
        [Newtonsoft.Json.JsonProperty("clientId", Required = Newtonsoft.Json.Required.Always)]
        public string ClientId { get; set; }
    
        /// <summary>The client secret value used when clients request tokens to access the API</summary>
        ...
        [Newtonsoft.Json.JsonProperty("grantType", Required = Newtonsoft.Json.Required.Always)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public ApiClientNewGrantType GrantType { get; set; }
    
        /// <summary>An optional brief summary describing the API client and its purpose</summary>
        [Newtonsoft.Json.JsonProperty("description", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Description { get; set; }
        ...
        public static ApiClientNew FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ApiClientNew>(data);
        }
    
    }
    
    /// <summary>Represents an object that can be provided to change an API client's secret value.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class ApiClientSecretReset 
    {
        /// <summary>The client secret value used when clients request tokens to access the API</summary>
        [Newtonsoft.Json.JsonProperty("newClientSecret", Required = Newtonsoft.Json.Required.Always)]
        ...
        public static ApiClientSecretReset FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ApiClientSecretReset>(data);
        }
    
    }
    
    /// <summary>Encapsulates the basic properties of a dashboard used by EMS web application users to view EMS-related data.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class Dashboard 
    {
        /// <summary>The unique integer identifier of the dashboards.</summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? Id { get; set; }
    
        /// <summary>The title of the dashboard typically rendered in the page header of a displayed dashboard.</summary>
        [Newtonsoft.Json.JsonProperty("title", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Title { get; set; }
    
        /// <summary>A detailed description that describes the contents of the dashboard.</summary>
        [Newtonsoft.Json.JsonProperty("description", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Description { get; set; }
    ...
    /// <summary>Represents a group that is used to control security for website users that are members of the group.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class Group 
    {
        /// <summary>The unique integer identifier of the group.</summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? Id { get; set; }
    
        /// <summary>The unique, user friendly, name of the group.</summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.Always)]
        public string Name { get; set; }
    
        /// <summary>A brief summary describing the group and its members and purpose.</summary>
        [Newtonsoft.Json.JsonProperty("description", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Description { get; set; }
    ...
    /// <summary>Represents a user account that can be used to access the website.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class User 
    {
        /// <summary>The unique integer identifier of the user.</summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? Id { get; set; }
    
        /// <summary>The Active Directory username of the user, typically in the form of "domain\user.name". If not in an 
        ///             environment with multiple domains, the domain name is not needed.</summary>
        [Newtonsoft.Json.JsonProperty("username", Required = Newtonsoft.Json.Required.Always)]
        public string Username { get; set; }
    
        /// <summary>Indicates whether the account lockout policy applies to this user, causing them to be locked out of the
        ///             application for a configured amount of time after failed login attempts.</summary>
        [Newtonsoft.Json.JsonProperty("lockoutPolicyEnabled", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? LockoutPolicyEnabled { get; set; }
    
        /// <summary>The list of roles to which the user is a member. Only values "Admin", "Developer", "DashboardEditor", and
        ///             "DashboardViewer" are supported.</summary>
        [Newtonsoft.Json.JsonProperty("roles", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<string> Roles { get; set; }
    
        /// <summary>The Tableau username to which this user is linked. This user name is only needed if different than the user 
        ///             name.</summary>
        [Newtonsoft.Json.JsonProperty("tableauUsername", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string TableauUsername { get; set; }
    
        /// <summary>A read-only value indicating the last time the user logged into the application.</summary>
        ...
        /// <summary>A read-only value indicating the time that the user will no longer be locked out. Null if the user is not 
        ///             currently locked out.</summary>
        ...
        /// <summary>A read-only value indicating the number of times the user failed to login.</summary>
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class DashboardsImport 
    {
        /// <summary>The list of imported dashboards and information gathered for each performed import.</summary>
        ...
        public System.Collections.ObjectModel.ObservableCollection<DashboardImport> Imports { get; set; }
    
        /// <summary>A summary messaged intended to be shown to users of what happened in the import process.</summary>
        [Newtonsoft.Json.JsonProperty("summary", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public ApiMessage Summary { get; set; }
        ...
        public static DashboardsImport FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<DashboardsImport>(data);
        }
    ...
    /// <summary>Represents a message used to provide information to users about an action that took place in an API request.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class DashboardImport 
    {
        /// <summary>The deserialized {Adi.Ems.Web.Api.V2.Model.Admin.DashboardImport.Dashboard} instance created in the import process.</summary>
        ...
        /// <summary>A list of messages indicating the status of the import and any extra information that may be useful to 
        ///             convey to a user performing an import.</summary>
        [Newtonsoft.Json.JsonProperty("messages", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<ApiMessage> Messages { get; set; }
    
        /// <summary>A value indicating whether any of the messages included in this instance is an error.</summary>
        ...
        /// <summary>A value indicating whether any of the messages included in this instance is a warning.</summary>
        [Newtonsoft.Json.JsonProperty("hasWarnings", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public static DashboardImport FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<DashboardImport>(data);
        }
    ...
    /// <summary>Represents a structure for specifying one or existing dashboard IDs.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class DashboardIds 
    {
        /// <summary>An array specifying one or more unique IDs of existing dashboards.</summary>
        [Newtonsoft.Json.JsonProperty("ids", Required = Newtonsoft.Json.Required.Always)]
        public System.Collections.ObjectModel.ObservableCollection<int> Ids { get; set; } = new System.Collections.ObjectModel.ObservableCollection<int>();
        ...
        public static DashboardIds FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<DashboardIds>(data);
        }
    
    }
    
    /// <summary>Represents an EMS system that can be used and accessed by users of the website.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class EmsSystem 
    {
        /// <summary>The unique integer identifier of the EMS system.</summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? Id { get; set; }
    
        /// <summary>The unique, user friendly, name of the EMS system.</summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.Always)]
        public string Name { get; set; }
    
        /// <summary>The "Dir Adi" URI where the EMS system installation is located, used to access the EMS system's resources.</summary>
        [Newtonsoft.Json.JsonProperty("dirAdi", Required = Newtonsoft.Json.Required.Always)]
        public string DirAdi { get; set; }
    
        /// <summary>The path to the collection location indicating where data collections for this EMS system should go.</summary>
        ...
        /// <summary>A brief summary describing the EMS system and its purpose.</summary>
        [Newtonsoft.Json.JsonProperty("description", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Description { get; set; }
    ...
    public partial class AsyncQueryData 
    {
        ...
        [Newtonsoft.Json.JsonProperty("rows", Required = Newtonsoft.Json.Required.Always)]
        public System.Collections.ObjectModel.ObservableCollection<string> Rows { get; set; } = new System.Collections.ObjectModel.ObservableCollection<string>();
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class EmsSystem2 
    {
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? Id { get; set; }
        ...
        public static EmsSystem2 FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<EmsSystem2>(data);
        }
    ...
    public partial class Bucket 
    {
        ...
        public EmsSystem2 AssociatedEmsSystem { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.73.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum ApiClientNewGrantType
    {
        [System.Runtime.Serialization.EnumMember(Value = "trusted")]
        Trusted = 0,
