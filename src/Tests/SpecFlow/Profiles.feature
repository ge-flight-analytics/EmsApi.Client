...
Scenario: Get APM profile results for a specific flight with out processing diagnostics
    Given A valid API endpoint
    When I run GetResults and enter a flight id of 1 and a profile id of 'A7483C44-9DB9-4A44-9EB5-F67681EE52B0' with processing diagnostics turned off
