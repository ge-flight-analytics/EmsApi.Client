...
namespace EmsApi.Client.V2.Access
{
    ...
    public class ProfilesAccess : RouteAccess
    {
        ...
        /// The optional call context to include.
        /// </param>
        public virtual Task<ProfileGlossary> GetGlossaryAsync( string profileId, int? profileVersion = null, string format = null, CallContext context = null )
        {
            return CallApiTask( api => api.GetProfileGlossary( profileId, profileVersion, format, context ) );
        }
        ...
        /// The optional call context to include.
        /// </param>
        public virtual ProfileGlossary GetGlossary( string profileId, int? profileVersion = null, string format = null, CallContext context = null )
        {
            return AccessTaskResult( GetGlossaryAsync( profileId, profileVersion, format, context ) );
        }
