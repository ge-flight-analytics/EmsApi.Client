...
namespace EmsApi.Client.V2
{
    ...
    public class EmsApiService : IDisposable
    {
        ...
        /// <summary>
        /// Access to EMS file dispatcher routes.
        /// </summary>
        public EfdAccess Efd { get; set; }
        ...
        /// <summary>
        /// Access to the alert routes.
        /// </summary>
        public AlertAccess Alerts { get; set; }
        ...
        private void InitializeAccessProperties()
        {
            ...
            Efd = InitializeAccessClass<EfdAccess>();
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            Alerts = InitializeAccessClass<AlertAccess>();
        }
